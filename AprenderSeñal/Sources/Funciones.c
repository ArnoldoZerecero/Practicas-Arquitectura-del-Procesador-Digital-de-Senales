...
void vfnMemSet(unsigned long * pdwDest, unsigned char bByteToFill, unsigned short wSize)
{
	...
	{
		*pdwDest++ = bByteToFill; /*La posición actual del arreglo adquiere el caracter especificado*/
	}
}
