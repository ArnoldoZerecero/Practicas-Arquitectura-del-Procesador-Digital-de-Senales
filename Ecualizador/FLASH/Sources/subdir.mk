...
Sources/Ecualizador.o: ../Sources/Ecualizador.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/Ecualizador.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/Ecualizador.o"
	@echo 'Finished building: $<'
	@echo ' '
